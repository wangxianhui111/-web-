...
| 模块 | 说明 | 优先级 | 状态 |
|------|------|--------|------|
| 角色管理 | 角色的CRUD、分配权限 | 高 | 待开发 |
| 菜单管理 | 菜单的CRUD、层级关系、权限分配 | 高 | 待开发 |
| 部门管理 | 组织架构、公司/部门/岗位 | 中 | 待开发 |
| 岗位管理 | 职位管理 | 中 | 待开发 |
...
|------|------|--------|------|
| 操作日志 | 记录用户操作行为 | 高 | 待开发 |
| 登录日志 | 记录登录时间、IP、设备 | 高 | 待开发 |
| 在线用户 | 查看当前在线用户 | 中 | 待开发 |
| 系统监控 | JVM、数据库、Redis监控 | 中 | 待开发 |

### 通用功能模块

| 模块 | 说明 | 优先级 | 状态 |
|------|------|--------|------|
| 文件上传/下载 | 通用文件服务（本地/OSS） | 高 | 待开发 |
| 字典管理 | 静态数据配置 | 中 | 待开发 |
| 参数配置 | 系统参数配置 | 中 | 待开发 |
| 定时任务 | 动态定时任务管理 | 中 | 待开发 |
